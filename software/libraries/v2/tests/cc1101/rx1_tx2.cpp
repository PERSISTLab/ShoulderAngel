...
void send_packet (void) {
    cc1101.init(radio);	
    cc1101.set_logical_channel(radio, LOGICAL_CHANNEL_2); // Needs to be the same in Tx and Rx
    cc1101.set_data_rate(radio, DATA_RATE_2); // Needs to be the same in Tx and Rx
    cc1101.set_tx_power(radio, SEND_POWER_2);
    cc1101.send_data(radio, tx_buffer, PACKET_SIZE_2);
    cc1101.sleep(radio);
}
