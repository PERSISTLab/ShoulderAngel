...
void send_packet (void) {
    cc1101.init(radio);	
    cc1101.set_logical_channel(radio, LOGICAL_CHANNEL_5); // Needs to be the same in Tx and Rx
    cc1101.set_data_rate(radio, DATA_RATE_5); // Needs to be the same in Tx and Rx
    cc1101.set_tx_power(radio, SEND_POWER_5);
